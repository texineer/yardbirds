            ...
            <div className="rounded-b-xl overflow-hidden border border-t-0 mb-1" style={{ borderColor: 'var(--border)' }}>
              {games.length === 0 ? (
                <div className="p-4 text-center">
                  <div className="text-sm mb-1" style={{ color: 'var(--navy-muted)' }}>Schedule not available yet</div>
                  <p className="text-xs" style={{ color: 'var(--navy-muted)' }}>Games will appear once the schedule is posted</p>
                </div>
              ) : (
