            ...
            <div className="rounded-b-xl overflow-hidden border border-t-0 mb-1" style={{ borderColor: 'var(--border)' }}>
              {games.length === 0 ? (
                <div className="p-4">
                  ...
                  <TeamsInTournament eventId={t.pg_event_id} />
                </div>
              ) : (
...
function TeamsInTournament({ eventId }) {
  ...
  if (!teams || teams.length === 0) return <p className="text-xs text-center" style={{ color: 'var(--navy-muted)' }}>Games will appear once the schedule is posted</p>
